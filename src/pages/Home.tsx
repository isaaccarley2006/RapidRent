  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover quality rental properties with RapidRent. Browse verified listings, connect with landlords, and find your ideal home." />
