...
export const LandlordDashboard: React.FC = () => {
  ...
  const pendingOffers = properties.reduce(
    (sum, property) =>
      sum +
      property.offers.filter((offer) => offer.status === "pending").length,
    0
  );
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.parentElement!.innerHTML =
                              '<div class="w-full h-full bg-gradient-to-br from-muted/40 to-muted/60 rounded-lg flex items-center justify-center"><svg class="w-6 h-6 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H3m2 0h4M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg></div>';
                          }}
                        />
                      ) : (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-3">
                        <span className="text-sm text-gray-600">
                          {property.offers.length} offer
                          {property.offers.length !== 1 ? "s" : ""}
                        </span>
                        <span
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {property.offers.length > 0 && (
                        <Button
                          ...
                          className="bg-primary hover:bg-primary/90 text-white rounded-xl"
                          onClick={() =>
                            navigate(`/property/${property.id}/offers`)
                          }
                        >
