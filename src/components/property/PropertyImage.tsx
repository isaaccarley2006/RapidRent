  ...
  return (
    <div className="mb-12">
      <Carousel className="w-full">
        ...
        <CarouselPrevious className="left-4 bg-background/80 backdrop-blur-sm border-0 shadow hover:bg-background/90" />
        <CarouselNext className="right-4 bg-background/80 backdrop-blur-sm border-0 shadow hover:bg-background/90" />
      </Carousel>
    </div>
  );
};
