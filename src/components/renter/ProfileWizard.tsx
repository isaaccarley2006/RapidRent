...
import {
  renterProfileWizardSchema,
  RenterProfileWizardFormData,
} from "@/schemas/renter";
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <Label htmlFor="time_at_current_address">
                  Time at Current Address *
                </Label>
                <Select
                  onValueChange={(value) =>
                    setValue("time_at_current_address", value)
                  }
                >
                  <SelectTrigger>
                ...
                {errors.time_at_current_address && (
                  <p className="text-sm text-red-600 mt-1">
                    {errors.time_at_current_address.message}
                  </p>
                )}
              </div>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <Label htmlFor="target_move_in_date">
                  Target Move-in Date *
                </Label>
                <Input
                ...
                {errors.target_move_in_date && (
                  <p className="text-sm text-red-600 mt-1">
                    {errors.target_move_in_date.message}
                  </p>
                )}
              </div>
            </div>
